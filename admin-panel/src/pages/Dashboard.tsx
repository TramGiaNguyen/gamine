                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gap={3}>
                            ...
                            {/* Biểu đồ thống kê thiết bị truy cập */}
                            <Box gridColumn={{ xs: "span 12", md: "span 6" }}>
                                <Card>
                                    <CardHeader title="Thống kê thiết bị truy cập" />
                                    <Divider />
                                    <CardContent>
                                        <ResponsiveContainer width="100%" height={300}>
                                            <PieChart>
                                                ...
                                                >
                                                    {stats?.device_stats?.map((entry, index) => (
                                                        <Cell 
                                                            key={`cell-${index}`} 
                                                            fill={entry.device_type === 'Desktop' ? '#0088FE' : '#FF8042'} 
                                                            strokeWidth={2}
                                                        />
                                                    )) || []}
                                                </Pie>
                                                ...
                                                <Legend 
                                                    formatter={(value) => {
                                                        return value === 'Desktop' ? 'Máy tính' : 'Điện thoại';
                                                    }}
                                                />
                                            </PieChart>
                                        </ResponsiveContainer>
                            ...
                            {/* Biểu đồ thống kê bán hàng theo danh mục */}
                            <Box gridColumn={{ xs: "span 12", md: "span 6" }}>
                                <Card>
                                    <CardHeader title="Thống kê bán hàng theo danh mục" />
                                    <Divider />
                                    <CardContent>
                                        <ResponsiveContainer width="100%" height={300}>
                                            <PieChart>
                                                ...
                                                <Tooltip formatter={(value, name, props) => [`${value} sản phẩm`, props.payload.name]} />
                                                <Legend />
                                            </PieChart>
                                        </ResponsiveContainer>
                                    </CardContent>
